...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2014/12/8 20:00:00');

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">Сервер Запущен!</span></span>');
 timer.countDown();
}
